...
import edu.wgu.d387_sample_code.Changes.MessageController;
...
public class H2Bootstrap implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
        ...
        messageController.getWelcomeMessage();
        messageController.getPresentationMessage();
        System.out.println(messageController.welcomeMessageResult);
        System.out.println(messageController.presentationMessageResult);
	}
