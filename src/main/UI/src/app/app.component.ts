...
export class AppComponent implements OnInit{
  ...
  presentationMessage$!: Observable<string>;
    ...
    ngOnInit(){
      ...
      this.welcomeMessage$      = this.httpClient.get(this.baseURL + '/api/welcomeMessage', {responseType: 'text'});
      this.presentationMessage$ = this.httpClient.get(this.baseURL + '/api/presentationMessage', {responseType: 'text'});
